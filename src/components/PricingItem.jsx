...
function PricingItem(props) {
    ...
    return (
        <li className={`flex items-center space-x-3`}>
            ...
            <span className={classNames({ 'px-2 py-1 inline bg-indigo-100 text-indigo-700 rounded-lg text-sm lg:text-md font-medium': props.itemHighlight === true })}>{props.item}</span>
        </li>
    )
}
